...
from bip_utils import Bip39SeedGenerator, Bip44, Bip44Coins, Bech32Encoder
...
class SentinelTransactor:
    ...
    def __setup_account_and_client(self, mnemonic, grpcaddr, grpcport):
        ...
        self.__client = GRPCClient(host=grpcaddr, port=grpcport, ssl=False, protobuf="sentinel")
        self.__client.load_account_data(account=self.__account)


    def __get_account_number(self, address):
        tmp_stub = self._query_channel.unary_unary('/cosmos.auth.v1beta1.Query/Account', request_serializer=cosmos_auth_v1beta1_query_pb2.QueryAccountRequest.SerializeToString, response_deserializer=cosmos_auth_v1beta1_query_pb2.QueryAccountResponse.FromString)
    ...
    def SubscribeToGB(self, sentnode, gb):
        ...
        tx = Transaction(account=self.__account, fee=fee, gas=0, protobuf="sentinel", chain_id="sentinelhub-2")
        ...
        udvpn_cost = self.__client.estimate_gas(transaction=tx, update=True, multiplier=1.5)
